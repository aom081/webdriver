...
WebUI.navigateToUrl('https://katalon-demo-cura.herokuapp.com/#summary')
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'GG')
